...
-- Add foreign key for promotion_id in bookings table
ALTER TABLE bookings 
ADD CONSTRAINT fk_booking_promotion 
FOREIGN KEY (promotion_id) REFERENCES promotions(id) ON DELETE SET NULL;

-- Insert sample promotions data
INSERT INTO promotions (title, description, code, discount_type, discount_value, min_amount, max_discount, valid_from, valid_to, category, image, is_active) VALUES
