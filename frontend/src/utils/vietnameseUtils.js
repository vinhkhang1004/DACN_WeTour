/**
 * Utility functions for Vietnamese text processing (Frontend)
 */
...
export function normalizeSearchTerm(str) {
  if (!str) return '';
  return removeVietnameseDiacritics(str.trim());
}

/**
 * Check if search term matches text (case-insensitive, diacritic-insensitive)
